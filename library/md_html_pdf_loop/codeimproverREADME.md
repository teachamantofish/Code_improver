...
- Title: Create PDF from markdown-generated html via mkdocs.
- Description: The PDF is created from HTML styled with custom CSS. Update the CSS and generate a PDF to verify task and eval-driven changes are applied the new output. 
- Workflow: 
  - Create a task category for each page type
  - Create success criteria for each task
  - Create matching evals for each success criteria
  - Update the CSS in C:\GIT\Framemaker2Markdown\aps_embellisher\e_pdfhtml_and_pdf\css
  - Create a new PDF
...
- Output: C:\GIT\Framemaker2Markdown\aps_embellisher\e_pdfhtml_and_pdf\EmbellisherDeveloperGuide1.1.pdf
